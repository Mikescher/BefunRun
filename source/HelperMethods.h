...
#define RESULT_EC_INVALIDGRIDACC    203
#define RESULT_EC_INVALIDSTACKACC   204
#define RESULT_EC_PCWRAPPING        205
#define RESULT_EC_SELFMODIFICATION  206
#define RESULT_EC_DIVBYZERO         207
